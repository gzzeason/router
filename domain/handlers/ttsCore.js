...
const SEC_CH_HEADERS = {
  ...
  "sec-ch-ua-full-version-list":
    '"Chromium";v="146.0.7680.178", "Not-A.Brand";v="24.0.0.0", "Google Chrome";v="146.0.7680.178"',
  "sec-ch-ua-mobile": "?0",
  "sec-ch-ua-model": '""',
...
async function googleTts(text, lang) {
  ...
  body.append(
    "f.req",
    JSON.stringify([[[rpcId, JSON.stringify(payload), null, "generic"]]]),
  );
...
const TTS_PROVIDERS = {
  ...
  elevenlabs: {
    synthesize: async (text, model, credentials) => {
      ...
      const base64 = await elevenlabsTts(
        text,
        voiceId,
        credentials.apiKey,
        modelId,
