...
export default function OpenClawToolCard({
  ...
  const getConfigStatus = () => {
    ...
    const localMatch =
      ...
      currentProvider.baseUrl?.includes("0.0.0.0");
            ...
            <>
              <div className="flex flex-col gap-2">
                ...
                {(openclawStatus.agents || [])
                  ...
                  .map((agent) => (
                    ...
                    >
                      <span
                        className="w-32 shrink-0 text-xs text-primary text-right truncate"
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  disabled={!openclawStatus?.has9Router}
                  loading={restoring}
                >
                  <span className="material-symbols-outlined text-[14px] mr-1">
                    restore
