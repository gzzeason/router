...
function EmbeddingExampleCard({ providerId }) {
  ...
  const embeddingModels = getModelsByProviderId(providerId).filter(
    (m) => m.type === "embedding",
  );
    ...
    <Card>
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <Row label="Endpoint">
          <div className="flex items-center gap-2">
            <input
              ...
              onChange={(e) =>
                useTunnel
                  ? setTunnelEndpoint(e.target.value)
        ...
        <div className="mt-1">
          ...
          <pre className="bg-sidebar rounded-lg px-3 py-2.5 text-xs font-mono text-text-main overflow-x-auto whitespace-pre">
            {curlSnippet}
          </pre>
        </div>
...
function TtsExampleCard({ providerId }) {
  ...
  const modelFull =
    config.hasModelSelector && activeVoiceId && selectedModel
      ? `${providerAlias}/${selectedModel}/${activeVoiceId}`
      : activeVoiceId
        ? `${providerAlias}/${activeVoiceId}`
        : "";
        ...
        <div className="flex flex-col gap-2.5">
          ...
          {audioUrl ? (
            ...
            <div>
              ...
              <pre className="mt-1.5 bg-sidebar rounded-lg px-3 py-2.5 text-xs font-mono text-text-main overflow-x-auto whitespace-pre opacity-50">
