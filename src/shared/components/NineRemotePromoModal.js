        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-black/5 dark:border-white/5">
          <div className="flex items-center gap-3">
            ...
            <span
              ...
              style={{ fontFamily: "monospace", color: "#FF570A" }}
            >
              9Remote
            </span>
          </div>
        ...
        <div className="px-7 py-7 pb-9 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-2 text-center mt-2">
            <div
              ...
              style={{
                background: "#FF570A",
                boxShadow: "rgba(255,87,10,0.35) 0px 8px 32px",
              }}
            >
              <span
          ...
          <div className="flex gap-2 w-full">
            {FEATURES.map(({ icon, label, desc }) => (
              <div
                key={label}
                className="flex-1 flex flex-col items-center gap-1.5 py-4 px-1 rounded-xl border border-black/10 dark:border-white/10 bg-bg-alt"
              >
                <span
                  className="material-symbols-outlined"
                  style={{ fontSize: 22, color: "#ff6e33" }}
                >
                  {icon}
                </span>
            ...
            {BULLETS.map(({ icon, text }) => (
              <div key={icon} className="flex items-center gap-2.5">
                <span
                  ...
                  style={{ fontSize: 16, color: "#ff6e33" }}
                >
                  {icon}
                </span>
          ...
          <button
            ...
            style={{
              background: "#FF570A",
              boxShadow: "0 4px 16px rgba(255,87,10,0.35)",
            }}
          >
