        ...
        {mode === "oauth" && (
          <>
            <p className="text-xs text-text-muted">
              ...
              with redirect URI{" "}
              <code className="bg-sidebar px-1 rounded text-xs">
                {getRedirectUri()}
              </code>
            </p>
            <Input
        ...
        {mode === "pat" && (
          <>
            <p className="text-xs text-text-muted">
              ...
              with scopes:{" "}
              <code className="bg-sidebar px-1 rounded text-xs">api</code>,{" "}
              <code className="bg-sidebar px-1 rounded text-xs">read_user</code>
              , and{" "}
              <code className="bg-sidebar px-1 rounded text-xs">
                ai_features
              </code>
