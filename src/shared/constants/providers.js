...
export const FREE_PROVIDERS = {
  ...
  "gemini-cli": {
    ...
    deprecated: true,
    deprecationNotice:
      "Gemini CLI is designed exclusively for Gemini CLI. Using it with other tools (OpenClaw, Claude, Codex...) may result in account restrictions or bans.",
  },
...
export const OAUTH_PROVIDERS = {
  ...
  antigravity: {
    ...
    deprecated: true,
    deprecationNotice:
      "AG is designed exclusively for Antigravity IDE. Using it with other tools (OpenClaw, Claude, Codex...) may result in account restrictions or bans.",
  },
  codex: {
    id: "codex",
    alias: "cx",
...
export const APIKEY_PROVIDERS = {
  ...
  openai: {
    ...
    serviceKinds: ["llm", "embedding", "tts"],
    thinkingConfig: THINKING_CONFIG.effort,
  },
  anthropic: {
    id: "anthropic",
